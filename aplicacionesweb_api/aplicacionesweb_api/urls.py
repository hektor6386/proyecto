...
from aplicacionesweb_api.views import maters
...
urlpatterns = [
    ...
    #crear materia
        path('maters/', maters.MatersView.as_view()),
    #Maters data
        path('lista-maters/', maters.MatersAll.as_view()),
    #edit Maters
        path('maters-edit/', maters.MatersViewEdit.as_view()), 
